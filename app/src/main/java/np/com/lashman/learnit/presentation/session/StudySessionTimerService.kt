...
import np.com.lashman.learnit.util.Constants.ACTION_SERVICE_CANCEL
import np.com.lashman.learnit.util.Constants.ACTION_SERVICE_START
import np.com.lashman.learnit.util.Constants.ACTION_SERVICE_STOP
import np.com.lashman.learnit.util.Constants.NOTIFICATION_CHANNEL_ID
import np.com.lashman.learnit.util.Constants.NOTIFICATION_CHANNEL_NAME
import np.com.lashman.learnit.util.Constants.NOTIFICATION_ID
import np.com.lashman.learnit.util.pad
        ...
        intent?.action.let {
            when (it) {
                ACTION_SERVICE_START -> {
                    startForegroundService()  // Ensure immediate start of foreground service
